              ...
              return (
                ...
                >
                  ...
                  <div style={{ padding: 16 }}>
                    ...
                    <p style={{ fontSize: 14, color: "#3D5A57", lineHeight: 1.5, marginBottom: 12 }}>
                    ...
                    <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                      ...
                      >
                        <span>🧭</span> 
                        {district ? `Find Guides in ${district}` : `Find Guides for ${place.category || 'this place'}`}
                      </button>

                      {/* View Details Link */}
                      <Link 
                        to={`/category/${place.categoryId || 'beaches'}?district=${encodeURIComponent(district)}`}
                        style={{
                          color: "#C79A3E",
                          textDecoration: "none",
                          fontSize: 13,
