...
# Read the views file
with open('destinations/views.py', 'r', encoding='utf-8') as f:
    content = f.read()
...
# Check if old method exists and replace
if old_method in content:
    content = content.replace(old_method, new_method)
    with open('destinations/views.py', 'w', encoding='utf-8') as f:
        f.write(content)
    print("✅ Updated destinations/views.py")
else:
